...
LANGUAGES = {
    "IT": {
        ...
        "spinner": "🧙‍♂️ Sto elaborando il Travel Plan per {destination}...",
        ...
        "ad_tiqets": "Non rischiare il tutto esaurito a {destination}. Assicurati il posto e le migliori offerte su Tiqets",
        "ad_car": "Viaggia in libertà e noleggia un auto: Tariffe esclusive con Auto Europe",
        "ad_train": "Treni e Bus: Prenota su Omio",
        "ad_rest": "Esplora {destination} al miglior prezzo! Prenota su GetYourGuide",
        # Sidebar
    ...
    "EN": {
        ...
        "spinner": "🧙‍♂️ Processing Travel Plan for {destination}...",
        ...
        "ad_tiqets": "Don't risk sold out in {destination}. Secure spots and best deals on Tiqets",
        "ad_car": "Travel freely and rent a car: Exclusive rates with Auto Europe",
        "ad_train": "Trains and Buses: Book on Omio",
        "ad_rest": "Discover {destination} at the best rate! Book on GetYourGuide",
        # Sidebar
        "sb_book": "✈️ BOOKINGS",
